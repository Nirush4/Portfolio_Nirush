...
export function GradientSlideButton({
  ...
  return (
    <button
      ...
      className={cn(
        'relative inline-flex h-10 items-center justify-center gap-2 overflow-hidden rounded-md bg-black py-6 text-m font-medium whitespace-nowrap text-white transition-all duration-300 hover:scale-[105%] dark:bg-white dark:text-black hover:dark:text-white',
