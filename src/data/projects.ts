...
export const projects: Project[] = [
  {
    ...
    description:
      'A dynamic online shop built with vanilla JavaScript and real-time product data from an API.',
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Interactive elements (such as clickable product cards) allow users to explore product details, enhancing overall engagement.',
      },
      {
  ...
  },
  {
    ...
    description:
      'Frontend social media app with post management, interactions, and responsive design.',
